            ...
            <div class="navbar-inner">
                ...
                <div class="nav-right">
                            ...
                            <ul class="dropdown-menu shadow-lg border-0 mega-menu p-3">
                                <div class="row g-2">
                                    <?php foreach ($cats as $c): ?>
                                        <div class="col-md-4">
                                            <li><a class="dropdown-item py-2 px-3 rounded-2 category-link"
                                                    href="category.php?cat=<?= htmlspecialchars($c['slug']) ?>"><?= $c['name'] ?></a>
                                            </li>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
                    ...
                    <?php if (!empty($_SESSION['user_id'])): ?>
                        ...
                        <a href="cart.php" class="nav-icon-link me-2" title="Cart">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg p-2">
                                <li>
                                    <div class="px-3 py-2">
                                        <p class="mb-0 fw-bold"><?= htmlspecialchars($_SESSION['user_name'] ?? 'Member') ?>
                                        </p>
                                ...
                                <?php if (isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'admin'): ?>
                                    <li><a class="dropdown-item rounded-2" href="admin/admin_index.php"><i
                                                class="bi bi-speedometer2 me-2"></i> Dashboard</a></li>
                                <?php endif; ?>
                                <li><a class="dropdown-item rounded-2" href="my_profile.php"><i
                                            class="bi bi-person me-2"></i> My Profile</a></li>
                                <li><a class="dropdown-item rounded-2" href="wishlist.php"><i class="bi bi-heart me-2"></i>
                                        My Wishlist</a></li>
                                <li><a class="dropdown-item rounded-2" href="my_orders.php"><i
                    ...
                    <?php else: ?>
                        <!-- Login Modal Trigger (Not Logged In) -->
                    ...
                    <button class="navbar-toggler d-lg-none p-0 border-0 ms-2" type="button" data-bs-toggle="offcanvas"
...
<div class="offcanvas offcanvas-start mobile-menu-drawer" tabindex="-1" id="mobileMenu"
        ...
        <div class="menu-section mt-3">
            ...
            <ul class="list-unstyled">
                ...
                <?php if (!empty($_SESSION['user_id'])): ?>
                    ...
                    <li><a href="logout.php" class="menu-item text-danger"><i class="bi bi-box-arrow-right me-2"></i>
                            Logout</a></li>
                <?php else: ?>
                    <li><a href="#" class="menu-item" data-bs-toggle="modal" data-bs-target="#loginModal"
                            data-bs-dismiss="offcanvas"><i class="bi bi-person me-2"></i> Login / Register</a></li>
                <?php endif; ?>
            </ul>
        </div>
    </div>
...
<!-- BOTTOM NAVIGATION (MOBILE ONLY) removed per request -->
<!-- Navigation links are handled via the hamburger menu and header icons -->
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <div class="modal-body p-4">
                ...
                <div id="loginView">
                    <form id="ajaxLoginForm">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <a href="javascript:void(0)" onclick="showLoginSubView('forgotEmailView')"
                                class="small text-secondary text-decoration-none">Forgot password?</a>
                        </div>

                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary rounded-pill fw-bold py-2"
                                style="background: var(--primary-color); border: none;">Login Now</button>
                        </div>
                    </form>
                </div>
                ...
                <div id="loginOtpView" class="d-none text-center">
                    ...
                    <form id="loginVerifyOtpForm">
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary rounded-pill fw-bold py-2">Verify &
                                Login</button>
                            <button type="button" onclick="showLoginSubView('loginView')"
                                class="btn btn-link btn-sm text-decoration-none text-muted">Back to Login</button>
                        </div>
                    </form>
                </div>
                ...
                <div id="forgotEmailView" class="d-none">
                    ...
                    <form id="forgotPassEmailForm">
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary rounded-pill fw-bold py-2"
                                style="background: var(--primary-color); border: none;">Send OTP</button>
                            <button type="button" onclick="showLoginSubView('loginView')"
                                class="btn btn-link btn-sm text-decoration-none text-muted">Back to Login</button>
                        </div>
                    </form>
                ...
                <div id="forgotOtpView" class="d-none text-center">
                    ...
                    <form id="forgotPassOtpForm">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <button type="button" onclick="showLoginSubView('forgotEmailView')"
                                class="btn btn-link btn-sm text-decoration-none text-muted">Resend OTP</button>
                        </div>
                    </form>
                </div>
                    ...
                    <form id="forgotPassResetForm">
                        <div class="mb-3">
                            ...
                            <input type="password" name="new_password" id="resetPassword"
                                class="form-control rounded-pill" placeholder="******" required minlength="8">

                            <!-- Password Requirements Checklist (Reset) -->
                            <div class="password-checklist mt-2 p-2 bg-light rounded-3 small">
                                <div id="reset-min8" class="text-danger"><i class="bi bi-x-circle me-1"></i> Min 8
                                    characters</div>
                                <div id="reset-upper" class="text-danger"><i class="bi bi-x-circle me-1"></i> At least
                                    one uppercase</div>
                                <div id="reset-lower" class="text-danger"><i class="bi bi-x-circle me-1"></i> At least
                                    one lowercase</div>
                                <div id="reset-number" class="text-danger"><i class="bi bi-x-circle me-1"></i> At least
                                    one number</div>
                                <div id="reset-special" class="text-danger"><i class="bi bi-x-circle me-1"></i> At least
                        ...
                        <div class="d-grid">
                            <button type="submit" id="resetPassBtn" class="btn btn-dark rounded-pill fw-bold py-2"
            ...
            <div class="modal-footer justify-content-center border-0 pb-4">
                <p class="small text-muted mb-0">Don't have an account? <a href="javascript:void(0)"
                        class="text-decoration-none fw-bold" style="color: var(--primary-color);" data-bs-toggle="modal"
...
<div class="modal fade" id="registerModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
                    ...
                    <form id="ajaxRegisterForm">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" name="mobile" class="form-control border-start-0 ps-0"
                                    pattern="[0-9]{10}" maxlength="10" placeholder="10-digit number" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row g-2">
                                <div class="col-6">
                                    <input type="text" name="door_no" class="form-control" placeholder="Door No"
                                        required>
                                </div>
                                <div class="col-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="password-checklist mt-2 p-2 bg-light rounded-3 small">
                                <div id="reg-min8" class="text-danger"><i class="bi bi-x-circle me-1"></i> Min 8
                                    characters</div>
                                <div id="reg-upper" class="text-danger"><i class="bi bi-x-circle me-1"></i> At least one
                                    uppercase</div>
                                <div id="reg-lower" class="text-danger"><i class="bi bi-x-circle me-1"></i> At least one
                                    lowercase</div>
                                <div id="reg-number" class="text-danger"><i class="bi bi-x-circle me-1"></i> At least
                                    one number</div>
                                <div id="reg-special" class="text-danger"><i class="bi bi-x-circle me-1"></i> At least
                                    one special character</div>
                            </div>
                        </div>
                        ...
                        <div class="d-grid mt-4">
                            <button type="submit" class="btn btn-primary rounded-pill fw-bold py-2"
                                style="background: var(--primary-color); border: none;">Sign Up</button>
                        </div>
                    </form>
                </div>
                ...
                <div id="registerOtpView" class="d-none text-center">
                    ...
                    <form id="registerVerifyOtpForm">
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary rounded-pill fw-bold py-2">Verify
                                Account</button>
                            <button type="button" onclick="showRegisterSubView('registerView')"
                                class="btn btn-link btn-sm text-decoration-none text-muted">Back to Sign Up</button>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal-footer justify-content-center border-0 pb-4">
                <p class="small text-muted mb-0">Already have an account? <a href="javascript:void(0)"
                        class="text-decoration-none fw-bold" style="color: var(--primary-color);" data-bs-toggle="modal"
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Function to close Products dropdown
        function closeProductsDropdown() {
            const productsDropdown = document.getElementById('productsDropdown');
            if (productsDropdown) {
                const dropdownElement = productsDropdown.querySelector('[data-bs-toggle="dropdown"]');
                if (dropdownElement) {
        ...
        // Close Products dropdown when a category is clicked
        ...
        // Close Products dropdown when Wishlist, Cart, or Profile are clicked
        const wishlistLink = document.querySelector('a[href="wishlist.php"]');
        const cartLink = document.querySelector('a[href="cart.php"]');
        const profileDropdowns = document.querySelectorAll('.nav-right > .dropdown > [data-bs-toggle="dropdown"]');

        if (wishlistLink) {
            wishlistLink.addEventListener('click', closeProductsDropdown);
        }

        if (cartLink) {
            cartLink.addEventListener('click', closeProductsDropdown);
        }

        profileDropdowns.forEach(dropdown => {
            dropdown.addEventListener('click', closeProductsDropdown);
        });

        // Close Products dropdown when search form is submitted
        const searchForm = document.querySelector('.search-form');
        if (searchForm) {
            searchForm.addEventListener('submit', closeProductsDropdown);
        }

        // Close Products dropdown when clicking outside the navbar
        document.addEventListener('click', function (e) {
            const navbar = document.querySelector('.custom-navbar');
            const productsDropdown = document.getElementById('productsDropdown');
            if (navbar && productsDropdown && !navbar.contains(e.target)) {
                closeProductsDropdown();
            }
        });
    });
